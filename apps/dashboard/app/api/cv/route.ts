  ...
  try {
    ...
    const mappedCvs = projects.map((p) => {
      ...
      return {
        ...
        atsScore: parsedData.atsScore ?? calculateAtsScore(parsedData).totalScore,
        ...
        skills: Array.isArray(parsedData.skills) ? parsedData.skills : ['TypeScript', 'React', 'Next.js', 'Node.js'],
      };
    });
