    ...
    <div className="bg-navy-700 rounded-[10px] p-5 text-white shadow-md border border-navy-800 flex flex-col justify-between transition-transform hover:scale-[1.01]">
      <div>
        <div className="flex items-center justify-between mb-3">
          ...
          <span className="text-xs font-bold text-amber-100 bg-amber-800/40 px-2 py-0.5 rounded-[10px]">
            Diskon 50%
          </span>
        </div>
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-2 py-2.5 px-4 rounded-[10px] bg-slate-900 hover:bg-black text-amber-300 font-bold text-xs shadow-lg transition border border-amber-400/30"
      >
